---
title: "50 Most Common Behavioral Interview Questions (2026)"
description: "The 50 behavioral interview questions you'll actually get, grouped by competency, plus a story-matrix prep method and 2 full STAR example answers."
app: alex
...
1. Tell me about a time you worked closely with someone whose style was very different from yours.
2. Describe a successful team project. What was your specific contribution?
3. Tell me about a time you had to rely on a teammate who wasn't delivering.
4. Give an example of putting the team's goal ahead of your own.
5. Tell me about a time you helped a new team member get up to speed.
6. Describe working with a difficult colleague. How did you make it work?
7. Tell me about collaborating across departments or time zones.
8. When did you last ask for help? What happened?

## Conflict and Disagreement

9. Tell me about a time you disagreed with your manager.
10. Describe a conflict with a coworker. How was it resolved?
11. Tell me about a time you were criticized unfairly.
12. Describe pushing back on a decision you thought was wrong.
13. Tell me about a time you had to deliver an unpopular message.
14. When have you compromised on something you cared about?
15. Tell me about a time you were caught between two stakeholders with opposite demands.
16. Describe receiving harsh feedback. What did you do with it?

Candidates lose the most points here, in two opposite ways: claiming they've never had a conflict (evasive) or telling a story where the other person is a villain. The winning frame: a legitimate disagreement between two reasonable people, resolved through something you did — data, a direct conversation, a trial run.

## Leadership and Influence

17. Tell me about a time you led without formal authority.
18. Describe motivating someone who was disengaged.
19. Tell me about a time you delegated something important.
20. Give an example of influencing a decision made above your level.
21. Tell me about an initiative you started from scratch.
22. Describe developing or mentoring someone.
23. Tell me about making a decision your team disagreed with.
24. When did you take responsibility for a group failure?

## Failure and Mistakes

25. Tell me about your biggest professional failure.
26. Describe a mistake that affected other people. How did you handle it?
27. Tell me about a time you missed a deadline.
28. Describe a decision you'd make differently today.
29. Tell me about a project that didn't achieve its goal.
30. When did you receive feedback that stung? What changed afterward?
...
33. Tell me about a time priorities changed suddenly.
34. Describe working on something with unclear requirements.
35. Tell me about learning a new skill or tool under time pressure.
36. How have you handled a major reorganization or leadership change?
37. Tell me about a time you had to change your approach mid-project.
38. Describe a situation where you had almost no guidance.
39. Tell me about adopting a process or tool you initially resisted.
40. When were you asked to do something outside your job description?

## Prioritization and Time Management

41. Tell me about a time you had too many things due at once.
42. How have you handled competing requests from two managers or clients?
43. Describe a time you had to say no to a stakeholder.
44. Tell me about a long-term project you kept on track alongside daily work.
45. Give an example of cutting scope to hit a date.
46. Tell me about a time you caught something important slipping through the cracks.
47. How did you decide what NOT to do in your busiest period?
48. Describe a deadline you hit only by changing how you worked.
49. Tell me about balancing quality against speed.
50. What's a system you built to keep yourself organized, and what problem forced you to build it?
...
**Situation:** "Two Decembers ago I was the only analyst supporting three teams, and in the same two-week window I had the annual board metrics package, a client data audit with a contractual deadline, and a VP asking for an ad-hoc churn analysis."

**Task:** "Together they were roughly 120 hours of work in an 80-hour window. My job was to make the trade-off explicit rather than silently doing all three badly."

**Action:** "I ranked by irreversibility: the audit had contractual penalties, the board package had a fixed date, the churn analysis had neither. Then I went to the VP with a specific offer: a one-page preliminary cut of the churn numbers now, full analysis in January. He took it. For the board package, I reused the previous quarter's template and cut two exploratory sections after confirming with the CFO's office that nobody read them — freeing about 15 hours for the audit. I also sent all three stakeholders a short note stating what they'd get and when, so nobody discovered the prioritization by surprise."

**Result:** "The audit passed with zero findings, the board package shipped a day early, and the full churn analysis landed January 8th — the VP said the one-pager had already answered his core question. My manager instituted the 'what they'll get and when' note as a team practice. I learned that overload is a communication problem before it's a time problem — the failure mode isn't dropping a ball, it's dropping it silently."
