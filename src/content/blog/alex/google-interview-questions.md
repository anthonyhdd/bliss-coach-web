---
title: "Top 40 Google Interview Questions (2026)"
description: "40 real Google interview questions grouped by the 4 attributes Google grades: Googliness, role knowledge, leadership, and GCA — with 3 full example answers."
app: alex
publishDate: 2026-07-03
keywords: ["google interview questions", "google behavioral interview questions", "googliness interview", "google hiring committee", "how google interviews"]
---

Google grades every candidate on four attributes: general cognitive ability (GCA), role-related knowledge, leadership, and Googliness. Every question you get — whether it sounds technical, behavioral, or hypothetical — is feeding a score on one of those four. Prepare by attribute, not by memorizing individual questions, and you'll be ready for variations you've never seen.

## How Google Actually Grades You

Each interviewer scores you independently on a 1–4 scale against the four attributes, then writes detailed feedback with specific evidence — quotes, examples, reasoning. That packet goes to a **hiring committee**: Googlers who were not in your interviews and who make the hire/no-hire recommendation based only on the written record. Google's own re:Work materials describe this structure publicly, and it has two implications:

1. **Your answers need to be quotable.** Vague answers produce vague notes, and vague notes die in committee. Specific numbers, named trade-offs, and clear decisions survive.
2. **One weak interview isn't fatal, but one "no evidence" attribute is.** If nobody could gather evidence of leadership, that gap no amount of charm fixes.

Interviewers use structured interviewing — the same questions and rubric across candidates for a role — which means the categories below are stable and preparable.

## GCA: General Cognitive Ability Questions

GCA is not brainteasers (Google retired those after finding they predicted nothing). It's how you structure ambiguous problems: clarify, decompose, weigh trade-offs, land on a defensible answer.

1. How would you improve Google Maps for a user in a city with unreliable GPS?
2. Our product's user engagement dropped 15% last quarter. Walk me through how you'd investigate.
3. You have two competing feature requests and resources for one. How do you decide?
4. How would you estimate the number of daily YouTube uploads, and what would you do with that number?
5. A metric you launched is being gamed by users. What now?
6. Design a system for a library to track overdue books, then tell me where it breaks at 100x scale.
7. Tell me about a time you had to make a decision with incomplete information.
8. If you joined this team tomorrow, what would you do in your first 30 days to figure out what matters?
...
13. How do you stay current in your field? Give me an example of something you learned recently and applied.
14. Tell me about a project where your first approach was wrong. How did you find out?
15. What tools or methods do you use that most of your peers don't?
16. Critique a product or system you know well. What would you change and why?
17. Describe a time you had to learn a new domain quickly to deliver.
18. What's a strong opinion you hold about how work in your field should be done?
...
Google explicitly looks for "emergent leadership" — stepping up without the title, and just as importantly, stepping back when someone else is better positioned. You do not need to have managed people.

21. Tell me about a time you led a project without formal authority.
22. Describe a time you saw a problem nobody owned and did something about it.
23. Tell me about a time you had to influence a decision above your pay grade.
24. Give me an example of stepping back and letting someone else lead. Why?
25. Tell me about a time you disagreed with your team's direction. What did you do?
26. How have you helped a struggling teammate?
27. Describe a time you had to rally people around an unpopular decision.
28. Tell me about a time you took ownership of a failure that wasn't entirely yours.
29. How did you handle a situation where two stakeholders wanted opposite things?
30. What's the hardest feedback you've ever delivered?
...
33. Tell me about a time you did something for a user or customer that wasn't in your job description.
34. When did you last change your mind because of someone else's argument?
35. Tell me about a time you worked with someone very different from you.
36. Describe a situation where the right thing to do conflicted with the easy thing.
37. Tell me about a failure. What did you learn, and what did you change afterward?
38. How do you handle working on something when the goal keeps shifting?
39. Tell me about a time you gave credit to someone else for work you contributed to.
40. What do you do when you receive feedback you disagree with?

## Three Full Example Answers

### "Tell me about a time you led a project without formal authority." (Leadership)
...
No. Google publicly dropped brainteasers after internal research showed they didn't predict job performance. Estimation questions still appear, but they're graded on structure and reasoning, not the number.
