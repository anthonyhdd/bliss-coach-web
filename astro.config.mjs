...
export default defineConfig({
  ...
  integrations: [
    sitemap({
      ...
      // Keep the private studio gallery out of the sitemap. Its URL is public
      ...
      // /orbit/ is a founder design alternative of the home (noindex too).
      filter: (page) => !page.includes('/studio/') && !page.includes('/orbit/'),
    }),
  ],
});
